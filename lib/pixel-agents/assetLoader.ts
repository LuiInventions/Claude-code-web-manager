...
export type { CharacterDirectionSprites } from './core/assets/types.js';
export type { PetManifest, PetSpriteFrames } from './core/assets/types.js';

// Vendored from pixel-agents server/src/constants.ts (sole symbol used here).
